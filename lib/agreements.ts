...
IE Global and Partner may be referred to individually as a "Party" and together as the "Parties".`,
  sections: [
    ...
    { title: '7) Fees & Payment', content: '7.1 {{fee_text}}\n\n7.2 Invoicing and payment: Partner issues invoices for amounts due. IE Global pays within {{invoice_days}} days of invoice date. For revenue-share (Model D): within 7 days after IE Global receives client payment, IE Global will provide Partner a remittance statement showing the received amount and the revenue-share calculation. Partner then issues an invoice for the revenue-share amount; IE Global pays within {{invoice_days}} days of invoice date.\n\n7.3 Revenue share – definitions (Model D only): "Net Project Revenue" means amounts actually received by IE Global from the client for the specific project under the applicable SOW, excluding: VAT, refunds, chargebacks, and explicit pass-through third-party costs that were (i) pre-approved in writing and (ii) separately itemized to the client. Partial or milestone payments: revenue share is calculated on each payment as received. Late client payments: Partner\'s share is due only after IE Global receives payment. Refunds after payout: IE Global may offset future revenue-share payments, or Partner shall reimburse pro rata. Partner may request reasonable supporting evidence for a given project\'s calculation and, once per year per project, may request a light audit (review of relevant invoices and payment records) on 14 days\' notice.\n\n7.4 Late payment interest: For B2B commercial transactions (handelstransacties), statutory interest applies at 10.15% p.a. (as per 1 July 2025). For non-trade transactions, statutory interest applies at 4% p.a. (as per 1 January 2026). Reasonable collection costs may be charged to the defaulting party.' },
    ...
    { title: '10) Data Protection (GDPR)', content: '10.1 If Partner processes personal data on IE Global\'s or a client\'s behalf (e.g., user research, interview notes, analytics), a Data Processing Agreement (DPA) under GDPR Art. 28 is required.\n10.2 Exhibit A (DPA) is attached and forms part of this Agreement. It covers: processing instructions, security measures, sub-processors, deletion/return of data upon termination, and breach notification without undue delay (and where feasible within 24–48 hours) to support IE Global\'s GDPR obligations.' },
    ...
    { title: '14) Limitation of Liability', content: '14.1 Neither Party is liable for indirect damages (lost profits, consequential damages) to the maximum extent permitted by law.\n14.2 Each Party\'s total liability under this Agreement is capped at the fees paid or payable under the relevant SOW in the {{liability_months}} months preceding the claim, but in no event less than €5,000 per SOW unless the SOW explicitly provides otherwise. For revenue-share arrangements where no payment has yet occurred, the cap shall be the fees reasonably expected under the SOW or €5,000, whichever is higher. Caps do not apply to fraud, wilful misconduct, or breach of confidentiality/IP.' },
