    ...
    <>
      ...
      <section className="py-16 bg-white">
        <div className="container-narrow prose prose-lg max-w-none">
          ...
          <p className="mt-6">
            For full company details and registration information, see our <Link href="/imprint" className="text-signal-red hover:underline font-semibold">Imprint page</Link>.
          </p>
        </div>
      </section>
    </>
